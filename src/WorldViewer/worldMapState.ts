...
export type WorldMapStateHex = {
  ...
  oceanCurrentDirectionJanuary: number,
  oceanCurrentSpeedJanuary: number,
  oceanCurrentDirectionJuly: number,
  oceanCurrentSpeedJuly: number,
  height: number,
  coordX: number,
  coordY: number,
  posX: number,
    ...
    hexes: {
      ...
      items: {
        ...
        properties: {
          ...
          windDirectionJanuary: { type: 'number', btype: 'uint16' },
          windSpeedJanuary: { type: 'number', btype: 'float32' },
          windDirectionJuly: { type: 'number', btype: 'uint16' },
          windSpeedJuly: { type: 'number', btype: 'float32' },
          oceanCurrentDirectionJanuary: { type: 'number', btype: 'uint16' },
          oceanCurrentSpeedJanuary: { type: 'number', btype: 'float32' },
          oceanCurrentDirectionJuly: { type: 'number', btype: 'uint16' },
          oceanCurrentSpeedJuly: { type: 'number', btype: 'float32' },
          ...
          fluxJanuary : { type: 'number', btype: 'float32' },
          fluxJuly : { type: 'number', btype: 'float32' },
